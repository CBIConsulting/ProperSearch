...
class App extends React.Component {
	...
	onChangeData (e) {
		e.preventDefault();
		let data = [], language = '', random = Math.floor(Math.random()* 10);
		          ...
		          <form className="form-horizontal" role="form">
		            <div className="form-group">
		                ...
		                <div className="form-inline">
		                	<input ref="listHeight" type="text" className="form-control input" id="listHeight" placeholder="List Height" defaultValue={this.state.listHeight} style={{marginRight: '30px'}}/>
		            ...
		            <div className="form-group">
		                ...
		                <div className="form-inline">
		                	<input ref="listElementHeight" type="text" className="form-control input" id="listElementHeight" placeholder="List Element Height" defaultValue={this.state.listRowHeight} style={{marginRight: '30px'}}/>
