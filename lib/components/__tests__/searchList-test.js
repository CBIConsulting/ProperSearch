...
describe('SearchList', function () {
	...
	it('handleElementClick singleSelection', function (done) {
		...
		// Click elements
		var node = _reactDom2['default'].findDOMNode(component.refs.test_11);
	...
	it('handleElementClick multiselect', function (done) {
		...
		// Click elements
		var node = _reactDom2['default'].findDOMNode(component.refs.test_2);
		var node2 = _reactDom2['default'].findDOMNode(component.refs.test_1); // Old selected item (unselect now)
		var node3 = _reactDom2['default'].findDOMNode(component.refs.test_0);
		var node4 = _reactDom2['default'].findDOMNode(component.refs.test_12);
		var node5 = _reactDom2['default'].findDOMNode(component.refs.test_9);
		_reactAddonsTestUtils2['default'].Simulate.click(node);
		_reactAddonsTestUtils2['default'].Simulate.click(node2);
		_reactAddonsTestUtils2['default'].Simulate.click(node3);
		_reactAddonsTestUtils2['default'].Simulate.click(node4);
		_reactAddonsTestUtils2['default'].Simulate.click(node5);
	...
	it('handleSelectAll all', function (done) {
		...
		// Click elements
		var node = _reactDom2['default'].findDOMNode(component.refs.test_all);
		_reactAddonsTestUtils2['default'].Simulate.click(node);
	...
	it('handleSelectAll nothing', function (done) {
		...
		// Click elements
		var node = _reactDom2['default'].findDOMNode(component.refs.test_none);
		_reactAddonsTestUtils2['default'].Simulate.click(node);
